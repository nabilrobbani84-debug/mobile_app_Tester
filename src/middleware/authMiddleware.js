...
import React from 'react'; // FIX: Wajib import React karena menggunakan React.useEffect
...
// FIX: Polyfill sederhana untuk atob di React Native jika tidak tersedia
...
// Gunakan fungsi atob global jika ada (Hermes terbaru mungkin sudah support), jika tidak pakai polyfill
const safeAtob = typeof atob === 'function' ? atob : decodeBase64;
...
export const isTokenExpired = (token) => {
    ...
    try {
        ...
        // FIX: Gunakan safeAtob bukan atob langsung
...
export const authGuard = async (navigation, targetRoute) => {
    ...
    if (!isValid) {
        ...
        // Note: Pastikan struktur navigasi Anda benar mendukung .reset()
